...
function runScan(){
  return new Promise(function(resolve,reject){
    ...
    console.log('sudo nmap -sn -T insane '+my_ip.substring(0,lastIndex)+'.1/24');
    exec('sudo nmap -sn -T insane '+my_ip.substring(0,lastIndex)+'.1/24',function(err,stdout,stderr){
      if (err){
