...
#define EXT_AMP_IO 27

#define INTA_GPIO 25
#define INTB_GPIO 26

#define GPIO_OUTPUT_PIN_SEL  ((1ULL<<J1850_DEBUG_PIN) | (1ULL<<J1850_OUTPUT_PIN) | (1ULL<<MAIN_POWER_IO) | (1ULL<<EXT_AMP_IO) | (1ULL<<DISPLAY_POWER_IO) | (1ULL<<AUDIO_STBY_IO) | (1ULL<<AUDIO_MUTE_IO))
