...
#define BLOWER_MOTOR_PIN 26

#define GPIO_OUTPUT_PIN_SEL  ((1ULL<<BLOWER_MOTOR_PIN) | (1ULL<<J1850_DEBUG_PIN) | (1ULL<<J1850_OUTPUT_PIN) | (1ULL<<MAIN_POWER_IO) | (1ULL<<DISPLAY_POWER_IO) | (1ULL<<AUDIO_STBY_IO) | (1ULL<<AUDIO_MUTE_IO))
